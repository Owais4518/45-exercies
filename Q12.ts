...
console.log(`Hello ${friendsName[0]}, hoe are you?`);
console.log(`Hello ${friendsName[1]}, hoe are you?`);
console.log(`Hello ${friendsName[2]}, hoe are you?`);
console.log(`Hello ${friendsName[3]}, hoe are you?`);